...
async function chatting(question) {
    ...
    // question ki embadding create krna

        const queryVector = await embeddings.embedQuery(question);

    // Embadding aayi useke baad usko vector DB me search krna ,Top 10 
    ...
    // Top 10+question ko LLM ko de dunga
